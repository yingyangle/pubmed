...
TRAIN_DATASET_FOLDER = 'bertdata/bertdata{}_{}'.format(TRAIN_DATASET, INPUT_TYPE)
UNANNOTATED_DATASET_FOLDER = 'bertdata/bertdata{}'.format(UNANNOTATED_DATASET)
...
BERT_MODEL_NICKNAME = '{}{}_{}'.format(BERT_MODEL_SELECTED, TRAIN_DATASET, INPUT_TYPE)
